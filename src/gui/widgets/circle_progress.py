...
class CircleProgress(QWidget):
    """Rich Circular Progress indicator widget using QPainter with smooth animations and gradient strokes."""
    ...
    def paintEvent(self, event: Any) -> None:
        ...
        if theme_name == "Corpus":
            ...
            glow_pen = QPen(QColor(accent_color.red(), accent_color.green(), accent_color.blue(), 25))
            ...
            if pct > 0:
                ...
                grad.setColorAt(1, accent_color.lighter(135))
                
                prog_pen = QPen()
                prog_pen.setWidthF(self.pen_width)
                prog_pen.setCapStyle(Qt.RoundCap)
                prog_pen.setBrush(QBrush(grad))
